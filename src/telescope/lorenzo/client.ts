...
import * as lorenzoBnblightclientV1TxRegistry from "./bnblightclient/v1/tx.registry";
...
import * as lorenzoBnblightclientV1TxAmino from "./bnblightclient/v1/tx.amino";
...
export const lorenzoAminoConverters = {
  ...
  ...lorenzoBnblightclientV1TxAmino.AminoConverter,
...
export const lorenzoProtoRegistry: ReadonlyArray<[string, GeneratedType]> = [...lorenzoAgentV1TxRegistry.registry, ...lorenzoBnblightclientV1TxRegistry.registry, ...lorenzoBtclightclientV1TxRegistry.registry, ...lorenzoBtcstakingV1TxRegistry.registry, ...lorenzoFeeV1TxRegistry.registry, ...lorenzoPlanV1TxRegistry.registry, ...lorenzoTokenV1TxRegistry.registry];
