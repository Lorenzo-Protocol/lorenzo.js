...
export const EventEthereumTx = {
  ...
  isSDK(o: any): o is EventEthereumTxSDKType {
  ...
  fromSDK(object: EventEthereumTxSDKType): EventEthereumTx {
    return {
  ...
  toSDK(message: EventEthereumTx): EventEthereumTxSDKType {
    const obj: any = {};
...
export const EventTxLog = {
  ...
  isSDK(o: any): o is EventTxLogSDKType {
  ...
  fromSDK(object: EventTxLogSDKType): EventTxLog {
    return {
      txLogs: Array.isArray(object?.tx_logs) ? object.tx_logs.map((e: any) => e) : []
    };
  },
  toSDK(message: EventTxLog): EventTxLogSDKType {
    const obj: any = {};
    if (message.txLogs) {
...
export const EventMessage = {
  ...
  isSDK(o: any): o is EventMessageSDKType {
  ...
  fromSDK(object: EventMessageSDKType): EventMessage {
    return {
  ...
  toSDK(message: EventMessage): EventMessageSDKType {
    const obj: any = {};
...
export const EventBlockBloom = {
  ...
  isSDK(o: any): o is EventBlockBloomSDKType {
    return o && (o.$typeUrl === EventBlockBloom.typeUrl || typeof o.bloom === "string");
  },
  ...
  fromSDK(object: EventBlockBloomSDKType): EventBlockBloom {
    return {
      bloom: object?.bloom
    };
  },
  toSDK(message: EventBlockBloom): EventBlockBloomSDKType {
    const obj: any = {};
