...
export const GenesisState = {
  ...
  isSDK(o: any): o is GenesisStateSDKType {
    return o && (o.$typeUrl === GenesisState.typeUrl || Array.isArray(o.accounts) && (!o.accounts.length || GenesisAccount.isSDK(o.accounts[0])) && Params.isSDK(o.params));
  },
  ...
  fromSDK(object: GenesisStateSDKType): GenesisState {
    return {
      accounts: Array.isArray(object?.accounts) ? object.accounts.map((e: any) => GenesisAccount.fromSDK(e)) : [],
  ...
  toSDK(message: GenesisState): GenesisStateSDKType {
    const obj: any = {};
    if (message.accounts) {
      obj.accounts = message.accounts.map(e => e ? GenesisAccount.toSDK(e) : undefined);
    } else {
      obj.accounts = [];
    }
...
export const GenesisAccount = {
  ...
  isSDK(o: any): o is GenesisAccountSDKType {
    return o && (o.$typeUrl === GenesisAccount.typeUrl || typeof o.address === "string" && typeof o.code === "string" && Array.isArray(o.storage) && (!o.storage.length || State.isSDK(o.storage[0])));
  },
  ...
  fromSDK(object: GenesisAccountSDKType): GenesisAccount {
    return {
      address: object?.address,
      code: object?.code,
      storage: Array.isArray(object?.storage) ? object.storage.map((e: any) => State.fromSDK(e)) : []
    };
  },
  toSDK(message: GenesisAccount): GenesisAccountSDKType {
    const obj: any = {};
    obj.address = message.address;
    obj.code = message.code;
    if (message.storage) {
      obj.storage = message.storage.map(e => e ? State.toSDK(e) : undefined);
    } else {
      obj.storage = [];
    }
    return obj;
