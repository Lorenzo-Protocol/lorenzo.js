...
export const Params = {
  ...
  isSDK(o: any): o is ParamsSDKType {
    return o && (o.$typeUrl === Params.typeUrl || typeof o.evm_denom === "string" && typeof o.enable_create === "boolean" && typeof o.enable_call === "boolean" && Array.isArray(o.extra_eips) && (!o.extra_eips.length || typeof o.extra_eips[0] === "bigint") && ChainConfig.isSDK(o.chain_config) && typeof o.allow_unprotected_txs === "boolean");
  },
  ...
  fromSDK(object: ParamsSDKType): Params {
    return {
      ...
      extraEips: Array.isArray(object?.extra_eips) ? object.extra_eips.map((e: any) => e) : [],
      chainConfig: object.chain_config ? ChainConfig.fromSDK(object.chain_config) : undefined,
  ...
  toSDK(message: Params): ParamsSDKType {
    ...
    message.chainConfig !== undefined && (obj.chain_config = message.chainConfig ? ChainConfig.toSDK(message.chainConfig) : undefined);
...
export const ChainConfig = {
  ...
  fromSDK(object: ChainConfigSDKType): ChainConfig {
    return {
  ...
  toSDK(message: ChainConfig): ChainConfigSDKType {
    const obj: any = {};
...
export const State = {
  ...
  fromSDK(object: StateSDKType): State {
    return {
      key: object?.key,
      value: object?.value
    };
  },
  toSDK(message: State): StateSDKType {
    const obj: any = {};
    obj.key = message.key;
...
export const TransactionLogs = {
  ...
  fromSDK(object: TransactionLogsSDKType): TransactionLogs {
    return {
      hash: object?.hash,
      logs: Array.isArray(object?.logs) ? object.logs.map((e: any) => Log.fromSDK(e)) : []
    };
  },
  toSDK(message: TransactionLogs): TransactionLogsSDKType {
    const obj: any = {};
...
export const TxResult = {
  ...
  fromSDK(object: TxResultSDKType): TxResult {
    return {
      ...
      bloom: object?.bloom,
      txLogs: object.tx_logs ? TransactionLogs.fromSDK(object.tx_logs) : undefined,
      ret: object?.ret,
  ...
  toSDK(message: TxResult): TxResultSDKType {
    ...
    message.txLogs !== undefined && (obj.tx_logs = message.txLogs ? TransactionLogs.toSDK(message.txLogs) : undefined);
    obj.ret = message.ret;
...
export const AccessTuple = {
  ...
  fromSDK(object: AccessTupleSDKType): AccessTuple {
    return {
      address: object?.address,
      storageKeys: Array.isArray(object?.storage_keys) ? object.storage_keys.map((e: any) => e) : []
    };
  },
  toSDK(message: AccessTuple): AccessTupleSDKType {
    const obj: any = {};
    obj.address = message.address;
