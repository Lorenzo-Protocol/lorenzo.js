...
export const MsgEthereumTx = {
  ...
  fromSDK(object: MsgEthereumTxSDKType): MsgEthereumTx {
    return {
  ...
  toSDK(message: MsgEthereumTx): MsgEthereumTxSDKType {
    const obj: any = {};
...
export const LegacyTx = {
  ...
  fromSDK(object: LegacyTxSDKType): LegacyTx {
    return {
      nonce: object?.nonce,
  ...
  toSDK(message: LegacyTx): LegacyTxSDKType {
    const obj: any = {};
...
export const AccessListTx = {
  ...
  fromSDK(object: AccessListTxSDKType): AccessListTx {
    return {
      ...
      value: object?.value,
      data: object?.data,
      accesses: Array.isArray(object?.accesses) ? object.accesses.map((e: any) => AccessTuple.fromSDK(e)) : [],
      v: object?.v,
      r: object?.r,
      s: object?.s
    };
  },
  toSDK(message: AccessListTx): AccessListTxSDKType {
    const obj: any = {};
    ...
    obj.data = message.data;
    if (message.accesses) {
      obj.accesses = message.accesses.map(e => e ? AccessTuple.toSDK(e) : undefined);
    } else {
      obj.accesses = [];
    }
    obj.v = message.v;
...
export const DynamicFeeTx = {
  ...
  fromSDK(object: DynamicFeeTxSDKType): DynamicFeeTx {
    return {
      chainId: object?.chain_id,
      nonce: object?.nonce,
  ...
  toSDK(message: DynamicFeeTx): DynamicFeeTxSDKType {
    const obj: any = {};
    obj.chain_id = message.chainId;
    obj.nonce = message.nonce;
...
export const ExtensionOptionsEthereumTx = {
  ...
  fromSDK(_: ExtensionOptionsEthereumTxSDKType): ExtensionOptionsEthereumTx {
    return {};
  },
  toSDK(_: ExtensionOptionsEthereumTx): ExtensionOptionsEthereumTxSDKType {
    const obj: any = {};
    return obj;
  },
...
export const MsgEthereumTxResponse = {
  ...
  fromSDK(object: MsgEthereumTxResponseSDKType): MsgEthereumTxResponse {
    return {
      hash: object?.hash,
  ...
  toSDK(message: MsgEthereumTxResponse): MsgEthereumTxResponseSDKType {
    const obj: any = {};
    obj.hash = message.hash;
    if (message.logs) {
