...
export const ExtensionOptionDynamicFeeTx = {
  ...
  isSDK(o: any): o is ExtensionOptionDynamicFeeTxSDKType {
  ...
  fromSDK(object: ExtensionOptionDynamicFeeTxSDKType): ExtensionOptionDynamicFeeTx {
    return {
      maxPriorityPrice: object?.max_priority_price
    };
  },
  toSDK(message: ExtensionOptionDynamicFeeTx): ExtensionOptionDynamicFeeTxSDKType {
    const obj: any = {};
