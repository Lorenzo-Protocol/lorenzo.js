...
import { QueryParamsRequest, QueryParamsResponse, QueryHashesRequest, QueryHashesResponse, QueryContainsRequest, QueryContainsResponse, QueryContainsBytesRequest, QueryContainsBytesResponse, QueryMainChainRequest, QueryMainChainResponse, QueryTipRequest, QueryTipResponse, QueryBaseHeaderRequest, QueryBaseHeaderResponse, QueryHeaderDepthRequest, QueryHeaderDepthResponse, QueryFeeRateRequest, QueryFeeRateResponse } from "./query";
...
export class QueryClientImpl implements Query {
  ...
  params(request: QueryParamsRequest = {}): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request("lorenzo.btclightclient.v1.Query", "Params", data);
    return promise.then(data => QueryParamsResponse.decode(new BinaryReader(data)));
  }
  hashes(request: QueryHashesRequest = {
    pagination: undefined
  }): Promise<QueryHashesResponse> {
    const data = QueryHashesRequest.encode(request).finish();
    const promise = this.rpc.request("lorenzo.btclightclient.v1.Query", "Hashes", data);
  ...
  contains(request: QueryContainsRequest): Promise<QueryContainsResponse> {
    ...
    const promise = this.rpc.request("lorenzo.btclightclient.v1.Query", "Contains", data);
  ...
  containsBytes(request: QueryContainsBytesRequest): Promise<QueryContainsBytesResponse> {
    ...
    const promise = this.rpc.request("lorenzo.btclightclient.v1.Query", "ContainsBytes", data);
    return promise.then(data => QueryContainsBytesResponse.decode(new BinaryReader(data)));
  }
  mainChain(request: QueryMainChainRequest = {
    pagination: undefined
  }): Promise<QueryMainChainResponse> {
    const data = QueryMainChainRequest.encode(request).finish();
    const promise = this.rpc.request("lorenzo.btclightclient.v1.Query", "MainChain", data);
  ...
  tip(request: QueryTipRequest = {}): Promise<QueryTipResponse> {
    ...
    const promise = this.rpc.request("lorenzo.btclightclient.v1.Query", "Tip", data);
  ...
  baseHeader(request: QueryBaseHeaderRequest = {}): Promise<QueryBaseHeaderResponse> {
    ...
    const promise = this.rpc.request("lorenzo.btclightclient.v1.Query", "BaseHeader", data);
  ...
  headerDepth(request: QueryHeaderDepthRequest): Promise<QueryHeaderDepthResponse> {
    ...
    const promise = this.rpc.request("lorenzo.btclightclient.v1.Query", "HeaderDepth", data);
  ...
  feeRate(request: QueryFeeRateRequest = {}): Promise<QueryFeeRateResponse> {
    ...
    const promise = this.rpc.request("lorenzo.btclightclient.v1.Query", "FeeRate", data);
...
export const createRpcQueryExtension = (base: QueryClient) => {
  ...
  return {
    ...
    feeRate(request?: QueryFeeRateRequest): Promise<QueryFeeRateResponse> {
      return queryService.feeRate(request);
    }
  };
};