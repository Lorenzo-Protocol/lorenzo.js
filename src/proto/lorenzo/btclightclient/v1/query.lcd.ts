...
import { QueryParamsRequest, QueryParamsResponseSDKType, QueryHashesRequest, QueryHashesResponseSDKType, QueryContainsRequest, QueryContainsResponseSDKType, QueryContainsBytesRequest, QueryContainsBytesResponseSDKType, QueryMainChainRequest, QueryMainChainResponseSDKType, QueryTipRequest, QueryTipResponseSDKType, QueryBaseHeaderRequest, QueryBaseHeaderResponseSDKType, QueryHeaderDepthRequest, QueryHeaderDepthResponseSDKType, QueryFeeRateRequest, QueryFeeRateResponseSDKType } from "./query";
export class LCDQueryClient {
  ...
  async params(_params: QueryParamsRequest = {}): Promise<QueryParamsResponseSDKType> {
    const endpoint = `lorenzo/btclightclient/v1/params`;
    return await this.req.get<QueryParamsResponseSDKType>(endpoint);
  }
  /* Hashes retrieves the hashes maintained by the module. */
  async hashes(params: QueryHashesRequest = {
    ...
    const endpoint = `lorenzo/btclightclient/v1/hashes`;
  ...
  async contains(params: QueryContainsRequest): Promise<QueryContainsResponseSDKType> {
    ...
    const endpoint = `lorenzo/btclightclient/v1/contains`;
  ...
  async mainChain(params: QueryMainChainRequest = {
    ...
    const endpoint = `lorenzo/btclightclient/v1/mainchain`;
  ...
  async tip(_params: QueryTipRequest = {}): Promise<QueryTipResponseSDKType> {
    const endpoint = `lorenzo/btclightclient/v1/tip`;
  ...
  async baseHeader(_params: QueryBaseHeaderRequest = {}): Promise<QueryBaseHeaderResponseSDKType> {
    const endpoint = `lorenzo/btclightclient/v1/baseheader`;
  ...
  async headerDepth(params: QueryHeaderDepthRequest): Promise<QueryHeaderDepthResponseSDKType> {
    const endpoint = `lorenzo/btclightclient/v1/depth/${params.hash}`;
    return await this.req.get<QueryHeaderDepthResponseSDKType>(endpoint);
  }
  /* FeeRate */
  async feeRate(_params: QueryFeeRateRequest = {}): Promise<QueryFeeRateResponseSDKType> {
    const endpoint = `lorenzo/btclightclient/v1/feeRate`;
    return await this.req.get<QueryFeeRateResponseSDKType>(endpoint);
  }
}