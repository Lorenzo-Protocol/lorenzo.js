...
export const createRPCQueryClient = async ({
  ...
  return {
    ...
    lorenzo: {
      ...
      btcstaking: {
        v1: (await import("./btcstaking/v1/query.rpc.Query")).createRpcQueryExtension(client)
      },
      fee: {
        v1: (await import("./fee/v1/query.rpc.Query")).createRpcQueryExtension(client)
      },
      plan: {
        v1: (await import("./plan/v1/query.rpc.Query")).createRpcQueryExtension(client)
      },
      token: {
