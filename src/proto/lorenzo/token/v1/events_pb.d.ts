...
// @generated from file lorenzo/token/v1/events.proto (package lorenzo.token.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message lorenzo.token.v1.EventRegisterPair
 */
export declare class EventRegisterPair extends Message<EventRegisterPair> {
  ...
  static readonly typeName = "lorenzo.token.v1.EventRegisterPair";
 ...
 * is toggled.
 *
 * @generated from message lorenzo.token.v1.EventToggleTokenConversion
 */
export declare class EventToggleTokenConversion extends Message<EventToggleTokenConversion> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "lorenzo.token.v1.EventToggleTokenConversion";
  static readonly fields: FieldList;
 ...
 *
 * @generated from message lorenzo.token.v1.EventConvertCoin
 */
export declare class EventConvertCoin extends Message<EventConvertCoin> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "lorenzo.token.v1.EventConvertCoin";
  static readonly fields: FieldList;
 ...
 *
 * @generated from message lorenzo.token.v1.EventConvertERC20
 */
export declare class EventConvertERC20 extends Message<EventConvertERC20> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "lorenzo.token.v1.EventConvertERC20";
  static readonly fields: FieldList;
